...
## Type: QssColor
c.colors.completion.item.selected.bg = solarized['green']

## Bottom border color of the selected completion item.
## Type: QssColor
c.colors.completion.item.selected.border.bottom = solarized['green']

## Top border color of the completion widget category headers.
## Type: QssColor
c.colors.completion.item.selected.border.top = solarized['green']
...
## for transparency.
## Type: QssColor
c.colors.hints.bg = solarized['orange']
...
## Type: QssColor
c.colors.keyhint.suffix.fg = solarized['green']
...
## Type: QssColor
c.colors.messages.warning.bg = solarized['green']

## Border color of a warning message.
## Type: QssColor
c.colors.messages.warning.border = solarized['green']
...
## Type: QssColor
c.colors.statusbar.caret.selection.bg = solarized['green']
...
## Type: QssColor
c.colors.statusbar.url.warn.fg = solarized['green']
...
## Type: QtColor
c.colors.tabs.indicator.start = solarized['green']
...
## Type: QtColor
c.colors.tabs.selected.even.bg = solarized['green']
...
## Type: QtColor
c.colors.tabs.selected.odd.bg = solarized['green']
